...
public class BinarySearchTree<E extends Comparable<? super E>> implements
    ...
    protected class BSTNode {
        ...
        /**
         * The height stores the height of the current node.
         */
        public int height;
    ...
    public void incCount(E data){
        incCount(data, overallRoot);
    }
    private BSTNode incCount(E data, BSTNode t) {
        if (overallRoot == null) {
            ...
            if (cmp == 0){
                ...
                t.left = (incCount(data,t.left));
                t.height = Math.max(height(t.left), height(t.right)) +1;
            }
            else if (cmp > 0){
                t.right = (incCount(data,t.right));
                t.height = Math.max(height(t.left), height(t.right)) +1;
            }
        }
        return t;
